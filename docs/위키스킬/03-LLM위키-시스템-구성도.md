...
> 현재 `peach-wiki` 최종 구조를 도식 중심으로 정리한 설명 문서다.
> 관련 문서: [패턴 분석](02-LLM위키-패턴-분석.md), [qmd 가이드](04-qmd-설치-활용-가이드.md), [종합 분석](05-qmd-LLM위키-종합분석.md)
...
`docs/wiki/` 안에는 `WIKI-AGENTS.md`, `wiki-index.md`, `wiki-log.md`, `concepts/`, `entities/`, `synthesis/`, `sources/`, `diagrams/`가 들어간다.
...
- [LLM Wiki 원문](01-LLM위키-원문.md)
- [LLM Wiki 패턴 분석](02-LLM위키-패턴-분석.md)
- [qmd 설치·활용 가이드](04-qmd-설치-활용-가이드.md)
- [qmd와 LLM Wiki 종합 분석](05-qmd-LLM위키-종합분석.md)
