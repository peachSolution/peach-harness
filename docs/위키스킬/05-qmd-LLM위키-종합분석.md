...
> 읽기 순서: [원문](01-LLM위키-원문.md) → [패턴 분석](02-LLM위키-패턴-분석.md) → [시스템 구성도](03-LLM위키-시스템-구성도.md) → [qmd 가이드](04-qmd-설치-활용-가이드.md) → 이 문서
...
즉, 배경 자료는 참고로만 두고, 운영 기준은 `skills/peach-wiki/SKILL.md`로 단일화한다.

## 무엇을 보러 어디로 가야 하나

| 궁금한 것 | 읽을 문서 |
|---|---|
| 아이디어 원형 | [LLM Wiki 원문](01-LLM위키-원문.md) |
| LLM Wiki 핵심 개념 | [패턴 분석](02-LLM위키-패턴-분석.md) |
| 구조를 그림으로 빠르게 이해하고 싶다 | [시스템 구성도](03-LLM위키-시스템-구성도.md) |
| qmd를 왜 쓰고 어떻게 붙이는가 | [qmd 가이드](04-qmd-설치-활용-가이드.md) |
| 실제 동작 규칙 | `skills/peach-wiki/SKILL.md` |
| harness 통합 의사결정 이력 | [harness 통합 분석](06-harness-통합-분석.md) |
