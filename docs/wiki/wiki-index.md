# wiki-index — peach-harness 위키 카탈로그
...
## concepts/ — 아키텍처·도메인 패턴

| 파일 | 설명 |
|------|------|
| [skill-architecture](concepts/skill-architecture.md) | 스킬 vs 서브에이전트 역할 분리, Bounded Autonomy, 모델 정책 |

## synthesis/ — 의사결정·트레이드오프
