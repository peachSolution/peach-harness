...
| **선호도 인코딩형** (12) | gen-backend, gen-db, gen-store, gen-ui, gen-ui-proto, add-api, add-cron, add-print, refactor-backend, refactor-frontend, team, team-refactor | Eval 충실도 검증 |
